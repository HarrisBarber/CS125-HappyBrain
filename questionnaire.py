...
class Questionnaire:
    ...
    def __init__(self, oldValues):
        ...
        q5 = Label(self.root, text = 
            "Are you fulfilling your responsibilities such as your career or relationships?", font = self.FONT)
        ...
        q12 = Label(self.root, text = "Have you been out of the house recently?", 
            font = self.FONT)
